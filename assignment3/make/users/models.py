...
class User(AbstractUser):
    ...
    fav_book_genre = models.ForeignKey(
       "categories.Category", related_name='books',blank=True, null=True, on_delete=models.CASCADE)
    fav_movie_genre =models.ForeignKey(
       "categories.Category", related_name='movies',blank=True,null=True, on_delete=models.CASCADE)